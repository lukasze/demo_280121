...
public class HobbitController {
    ...
    /*
        TODO 1 'programowanie do interfejsów' jest bardzo naturalne, gdy używamy Apring'a
          HobbitService to typ bazowy. Spring, żeby wstrzyknąć (dotraczyć implementację), potrzebuje
